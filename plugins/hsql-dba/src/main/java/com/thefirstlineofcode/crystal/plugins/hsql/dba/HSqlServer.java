...
import com.thefirstlineofcode.crystal.framework.IApplicationHomeAware;
...
public class HSqlServer implements IApplicationHomeAware {
	...
	private void doStart(String dataDir) throws IOException, AclFormatException {
		...
		properties.setProperty("server.database.0", String.format("file:%s/%s", dataDir, "crystal"));
		properties.setProperty("server.dbname.0", "crystal");
